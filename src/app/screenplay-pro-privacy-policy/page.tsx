// src/app/screenplay-pro-privacy-policy/page.tsx
...
const PAGE_SLUG = "screenplay-pro-privacy-policy";
...
export default async function ScreenplayProPrivacyPolicyPage() {
  try {
    const pageData = await getContentPageData(PAGE_SLUG);

    const breadcrumbItems = [
        { label: "Home", href: "/" },
        { label: pageData?.title || "Screenplay Pro Privacy Policy" },
    ];
