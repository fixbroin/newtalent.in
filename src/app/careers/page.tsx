      ...
      <div className="min-h-screen bg-muted/20 pb-16">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-4xl mx-auto mt-6 bg-card rounded-2xl shadow-sm border border-border/50 overflow-hidden">
            {pageData.imageUrl && (
                <div className="relative w-full aspect-[21/9] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2 md:p-10">
            ...
            <div className="p-2 md:p-10 lg:p-12">
                {!pageData.imageUrl && (
          ...
          <div className="max-w-4xl mx-auto mt-12 bg-primary/10 rounded-2xl p-8 md:p-12 text-center border border-primary/20">
              ...
              <h3 className="text-2xl font-headline font-bold text-foreground mb-3">Are you a professional Artist?</h3>
              ...
              <Link href="/artist-registration" passHref>
