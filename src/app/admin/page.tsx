            ...
            <Card className="border-none shadow-xl rounded-3xl bg-card">
              <CardHeader className="p-8 pb-4">
                <CardTitle className="text-xl font-black tracking-tight flex items-center">
                  <List className="mr-3 h-5 w-5 text-primary"/> Top Categories
                </CardTitle>
                <CardDescription>By number of artists</CardDescription>
              </CardHeader>
                ...
                <ScrollArea className="h-[400px]">
                  <div className="flex flex-col gap-3 pr-4 pb-4">
                    {analytics.topCategories.map((cat: any, idx: number) => (
                      <div key={cat.id} className="flex items-center justify-between p-3 rounded-2xl bg-muted/30 border border-transparent hover:border-primary/20 transition-all">
                          <div className="flex items-center gap-3">
                          ...
                          <Badge variant="secondary" className="rounded-lg font-bold">{cat.count} Artists</Badge>
                      </div>
                    ))}
                  </div>
                </ScrollArea>
