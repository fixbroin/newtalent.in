    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        const mergedSettings = { 
          ...
          maxArtistRadiusKm: firestoreData.maxArtistRadiusKm ?? defaultAppSettings.maxArtistRadiusKm, // Merge new field
        };
      ...
      <Tabs defaultValue="general" className="w-full">
        <div className="relative mb-6">
          <TabsList className="h-12 w-full justify-start gap-2 bg-transparent p-0 overflow-x-auto no-scrollbar flex-nowrap border-b border-border rounded-none">
            ...
            <TabsTrigger 
              ...
              className="relative h-12 rounded-none border-b-2 border-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-primary data-[state=active]:text-primary data-[state=active]:shadow-none whitespace-nowrap"
            >
              <Users className="mr-2 h-4 w-4" /> Artist
            </TabsTrigger>
            <TabsTrigger 
              value="slots"
              className="relative h-12 rounded-none border-b-2 border-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-primary data-[state=active]:text-primary data-[state=active]:shadow-none whitespace-nowrap"
        ...
        <TabsContent value="Artist">
            <Card>
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="maxArtistRadiusKm">Max Artist Service Radius (km)</Label>
                      <Input
                        ...
                        min="1"
                      />
                      <p className="text-xs text-muted-foreground">Sets the maximum service radius a Artist can select during registration.</p>
                    </div>
                </CardContent>
                <CardFooter className="border-t px-6 py-4">
                    <Button onClick={() => handleSaveSettings("Artist")} disabled={isSaving}>
                        {isSaving ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Save className="mr-2 h-4 w-4" />}
