...
import ExperienceLevelManager from "@/components/admin/artist-controls/ExperienceLevelManager";
import SkillLevelManager from "@/components/admin/artist-controls/SkillLevelManager";
import QualificationManager from "@/components/admin/artist-controls/QualificationManager";
import LanguageManager from "@/components/admin/artist-controls/LanguageManager";
import AdditionalDocTypeManager from "@/components/admin/artist-controls/AdditionalDocTypeManager";
import ArtistRegistrationToggleTab from "@/components/admin/artist-controls/ArtistRegistrationToggleTab";
import ArtistFeesSetupTab from "@/components/admin/artist-controls/ArtistFeesSetupTab"; 
import WithdrawalSettingsTab from "@/components/admin/artist-controls/WithdrawalSettingsTab";
import ArtistTermsManager from "@/components/admin/artist-controls/ArtistTermsManager";

export default function ArtistControlsPage() {
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl flex items-center">
            <Settings className="mr-2 h-6 w-6 text-primary" /> Artist Registration & Payouts
          </CardTitle>
          <CardDescription>
            Manage options for Artist registration forms, access, service fees, and withdrawals.
          </CardDescription>
        </CardHeader>
      </Card>
        ...
        <div className="relative mb-6">
          <TabsList className="h-12 w-full justify-start gap-2 bg-transparent p-0 overflow-x-auto no-scrollbar flex-nowrap border-b border-border rounded-none">
            ...
            <TabsTrigger 
              ...
              className="relative h-12 rounded-none border-b-2 border-transparent bg-transparent px-4 pb-3 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-primary data-[state=active]:text-primary data-[state=active]:shadow-none whitespace-nowrap"
            >
              <HandCoins className="mr-2 h-4 w-4"/>Artist Fees
            </TabsTrigger>
            <TabsTrigger 
