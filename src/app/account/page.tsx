...
function AccountPageContent() {
  ...
  const extraPagesItems = [
    ...
    { href: '/artist-registration', label: 'Join as an Artist', icon: UserPlus, condition: () => !isLoadingAppConfig && !!appConfig.isArtistRegistrationEnabled && !firestoreUser?.roles?.includes('artist')},
