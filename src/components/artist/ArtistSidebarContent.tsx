...
import { LayoutDashboard, UserCog, Briefcase, DollarSign, Star, Bell, ReceiptText, Banknote, ChevronRight, UserPlus } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/artist/connections', label: 'Connections', icon: UserPlus },
  { href: '/artist/profile', label: 'Profile & Settings', icon: UserCog },
  { href: '/artist/reviews', label: 'My Reviews', icon: Star },
  { href: '/artist/notifications', label: 'Notifications', icon: Bell },
];

export default function ArtistSidebarContent() {
