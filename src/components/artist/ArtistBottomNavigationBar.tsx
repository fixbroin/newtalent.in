...
import { LayoutDashboard, Briefcase, UserCog, ReceiptText, Menu, UserPlus } from 'lucide-react';
...
const ArtistBottomNavigationBar = () => {
  ...
  const navItems: NavItem[] = [
    { href: '/artist', label: 'Dashboard', icon: LayoutDashboard, isProtected: true },
    { href: '/artist/connections', label: 'Connections', icon: UserPlus, isProtected: true },
    { href: '/artist/profile', label: 'Profile', icon: UserCog, isProtected: true },
...
export default ArtistBottomNavigationBar;
