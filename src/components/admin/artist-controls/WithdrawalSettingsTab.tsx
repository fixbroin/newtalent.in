...
const WITHDRAWAL_CONFIG_DOC_ID = "withdrawal_Artist";
...
export default function WithdrawalSettingsTab() {
  ...
  const onSubmit = async (data: WithdrawalSettingsFormData) => {
    ...
    try {
      ...
      await triggerRefresh('withdrawal-Artist-config');
      toast({ title: "Success", description: "Artist withdrawal settings saved." });
    } catch (error) {
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Artist Withdrawal Settings</CardTitle>
          <CardDescription>Configure how Artists can withdraw their earnings.</CardDescription>
        </CardHeader>
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <Card>
          <CardHeader>
            <CardTitle>Artist Withdrawal Settings</CardTitle>
            <CardDescription>Configure how Artists can withdraw their earnings independently from referral withdrawals.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Enable Artist Withdrawals</FormLabel>
                    <FormDescription>Allow Artists to request withdrawal of their earnings.</FormDescription>
                  </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Minimum Artist Withdrawal Amount (₹)</FormLabel>
            ...
            <div className="space-y-2">
              ...
              <FormDescription>Select which payout methods are available to Artists.</FormDescription>
