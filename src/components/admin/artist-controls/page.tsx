...
import OptionalDocTypeManager from "@/components/admin/artist-controls/OptionalDocTypeManager";
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl flex items-center">
            <Settings className="mr-2 h-6 w-6 text-primary" /> Artist Registration Controls
          </CardTitle>
          <CardDescription>
            Manage options for Artist registration forms and toggle registration access.
          </CardDescription>
        </CardHeader>
      </Card>
