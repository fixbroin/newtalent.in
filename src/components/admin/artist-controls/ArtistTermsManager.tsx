...
export default function ArtistTermsManager() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({ title: "Success", description: "Artist terms updated successfully." });
    } catch (error) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center">
          <FileText className="mr-2 h-5 w-5 text-primary" /> Artist Terms & Conditions
        </CardTitle>
        <CardDescription>
          Edit the content that Artists must agree to during Step 4 of the registration process.
        </CardDescription>
      </CardHeader>
