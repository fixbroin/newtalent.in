  ...
  return (
    <Form {...form}>
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col h-full"> 
        ...
        <div className="p-2 space-y-6 flex-grow"> {/* Removed overflow-y-auto, parent handles scroll */}
            <FormField
            ...
            render={({ field }) => (
                ...
                {initialData && <FormDescription>Artist cannot be changed for an existing review.</FormDescription>}
                <FormMessage />
                </FormItem>
            )}
            />
        ...
        <div className="p-2 border-t bg-background flex flex-col sm:flex-row sm:justify-end gap-3 mt-auto">
