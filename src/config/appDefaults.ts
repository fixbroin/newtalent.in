...
export const defaultAppSettings: AppSettings = {
  ...
  isArtistRegistrationEnabled: true, // Added default
  maxArtistRadiusKm: 50, // Added default max Artist radius
  ...
  allowUsernameEdit: false, // Default to false as requested

  // Artist Fee Settings
  artistFeeType: 'fixed', // 'fixed' or 'percentage'
  artistFeeValue: 0, // Default to 0, meaning no fee
