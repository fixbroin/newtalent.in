...
import { Car, Droplets, Home, PaintRoller, PlugZap, ShieldCheck, Sparkles, Star, Users, Utensils, Wrench, ClockIcon, Layers, ShoppingBag as ServiceIconLucide, AirVent, Refrigerator, MessageSquare, Briefcase } from 'lucide-react';
...
export const whyChooseUsItems = [
  {
    ...
    icon: ShieldCheck,
    description: 'Connect with KYC-verified artists and genuine hiring professionals for safe and trusted collaborations.'
  },
  {
    id: 'wc2',
    title: 'Direct Communication',
    icon: MessageSquare,
    description: 'Chat directly with artists and creators without agents or middlemen. Faster connections, better opportunities.'
  },
  {
    id: 'wc3',
    title: 'Professional Portfolios',
    icon: Layers,
    description: 'Showcase your talent with high-quality photos, videos, and detailed profiles that stand out.'
  },
  {
    id: 'wc4',
    title: 'Casting & Auditions',
    icon: Briefcase,
    description: 'Explore casting calls, auditions, and collaboration opportunities across the entertainment industry.'
  },
];